# 🎬 Animación 3D y 🗣️ Lip Sync

## 🎨 Desarrollo y proceso universitario

Este repositorio reúne una selección de trabajos de **Animación 3D y Lip Sync realizados durante mi formación universitaria**.

A través de diferentes ejercicios y proyectos, trabajé aspectos relacionados con la animación de personajes, el movimiento corporal, la actuación, la expresión facial y la sincronización de diálogos.

Estos trabajos forman parte de mi proceso de aprendizaje y representan la aplicación práctica de conocimientos técnicos y artísticos adquiridos durante mis estudios.
...
La correcta utilización del timing permite desarrollar movimientos más fluidos, claros y expresivos.

---

## 🎭 Acting y expresión corporal
...
## 🔤 Fonemas y construcción de la boca
...
* 👄 Construcción de poses de boca.
* ⏱️ Sincronización con el diálogo.
...
Este repositorio contiene diferentes ejercicios y proyectos universitarios relacionados con:

* 🎬 Animación 3D.
* 🗣️ Lip Sync.
* 👄 Sincronización labial.
* 🎭 Acting de personajes.
* 🧍 Animación corporal.
* 👀 Expresiones faciales.
* ⏱️ Timing.
* 🔄 Movimiento y poses.
...
Estos trabajos representan parte de mi evolución dentro del área de animación de personajes.

Cada ejercicio permitió reforzar diferentes conocimientos y comprender progresivamente la relación entre:
...
Todo el material presentado en este repositorio fue realizado durante mi **formación universitaria**, como parte de diferentes ejercicios, proyectos y trabajos prácticos relacionados con la animación.

Estos trabajos reflejan el proceso mediante el cual fui desarrollando mis habilidades en:
